...
`lobehub-biz` is the **enterprise-facing** organization under [LobeHub][parent-org-link], dedicated to hosting private and proprietary projects that serve internal business needs, enterprise customers, and commercial deployment scenarios.

> [!IMPORTANT]
> Most repositories in this organization are **private**. If you are a team member and cannot access a specific repo, please contact the organization admin.
